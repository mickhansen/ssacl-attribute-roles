...
init = function(target) {
  if (target instanceof Sequelize.Model) {
    ...
    var accessGranted = function(method, attr, options){
      return !attr 
        // If no role is given apply default if any
        || !options.role && (typeof attr.roles !== 'object' || (attr.roles.default||{})[method] !== false)
        ...
        || options.role && (typeof attr.roles === 'object' && attr.roles[options.role] === undefined && (attr.roles.default||{})[method] !== false)
        // Apply given role if defined in attribute
        || (attr.roles[options.role]||{})[method] === true;
    };
    ...
    target.Instance.prototype.get = function(key, options) {
      ...
      if (key !== undefined) {
        ...
        if (accessGranted('get', attr, options)) {
      ...
      Object.keys(values).forEach(function (key) {
        ...
        else if ( accessGranted('get', attr, options) ) {
